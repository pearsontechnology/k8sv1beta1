...
from k8sv1beta1.models.v1beta1_deployment_rollback import V1beta1DeploymentRollback
...
class TestV1beta1DeploymentRollback(unittest.TestCase):
    ...
    def testV1beta1DeploymentRollback(self):
        ...
        """
        model = k8sv1beta1.models.v1beta1_deployment_rollback.V1beta1DeploymentRollback()
