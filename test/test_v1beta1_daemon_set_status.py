...
from k8sv1beta1.models.v1beta1_daemon_set_status import V1beta1DaemonSetStatus
...
class TestV1beta1DaemonSetStatus(unittest.TestCase):
    ...
    def testV1beta1DaemonSetStatus(self):
        ...
        """
        model = k8sv1beta1.models.v1beta1_daemon_set_status.V1beta1DaemonSetStatus()
