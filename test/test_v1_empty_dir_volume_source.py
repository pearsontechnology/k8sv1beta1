...
from k8sv1beta1.models.v1_empty_dir_volume_source import V1EmptyDirVolumeSource
...
class TestV1EmptyDirVolumeSource(unittest.TestCase):
    ...
    def testV1EmptyDirVolumeSource(self):
        ...
        """
        model = k8sv1beta1.models.v1_empty_dir_volume_source.V1EmptyDirVolumeSource()
