...
from k8sv1beta1.models.v1_glusterfs_volume_source import V1GlusterfsVolumeSource
...
class TestV1GlusterfsVolumeSource(unittest.TestCase):
    ...
    def testV1GlusterfsVolumeSource(self):
        ...
        """
        model = k8sv1beta1.models.v1_glusterfs_volume_source.V1GlusterfsVolumeSource()
