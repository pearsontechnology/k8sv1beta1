...
from k8sv1beta1.models.v1beta1_network_policy_peer import V1beta1NetworkPolicyPeer
...
class TestV1beta1NetworkPolicyPeer(unittest.TestCase):
    ...
    def testV1beta1NetworkPolicyPeer(self):
        ...
        """
        model = k8sv1beta1.models.v1beta1_network_policy_peer.V1beta1NetworkPolicyPeer()
