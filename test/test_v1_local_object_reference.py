...
from k8sv1beta1.models.v1_local_object_reference import V1LocalObjectReference
...
class TestV1LocalObjectReference(unittest.TestCase):
    ...
    def testV1LocalObjectReference(self):
        ...
        """
        model = k8sv1beta1.models.v1_local_object_reference.V1LocalObjectReference()
