...
from k8sv1beta1.models.v1beta1_replica_set_condition import V1beta1ReplicaSetCondition
...
class TestV1beta1ReplicaSetCondition(unittest.TestCase):
    ...
    def testV1beta1ReplicaSetCondition(self):
        ...
        """
        model = k8sv1beta1.models.v1beta1_replica_set_condition.V1beta1ReplicaSetCondition()
