...
class V1beta1DeploymentStrategy(object):
    ...
    """
    def __init__(self, type=None, rollingUpdate=None):
        """
    ...
    def rollingUpdate(self):
        """
        Gets the rollingUpdate of this V1beta1DeploymentStrategy.
        Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate.

        :return: The rollingUpdate of this V1beta1DeploymentStrategy.
    ...
    def rollingUpdate(self, rollingUpdate):
        """
        Sets the rollingUpdate of this V1beta1DeploymentStrategy.
        Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate.

        :param rollingUpdate: The rollingUpdate of this V1beta1DeploymentStrategy.
