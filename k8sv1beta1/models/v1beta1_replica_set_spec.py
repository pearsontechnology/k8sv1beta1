...
class V1beta1ReplicaSetSpec(object):
    ...
    def minReadySeconds(self):
        """
        Gets the minReadySeconds of this V1beta1ReplicaSetSpec.
        Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready)

        :return: The minReadySeconds of this V1beta1ReplicaSetSpec.
        :rtype: int
        """
    ...
    def minReadySeconds(self, minReadySeconds):
        """
        Sets the minReadySeconds of this V1beta1ReplicaSetSpec.
        Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready)

        :param minReadySeconds: The minReadySeconds of this V1beta1ReplicaSetSpec.
        :type: int
        """
