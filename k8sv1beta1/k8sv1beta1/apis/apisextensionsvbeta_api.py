...
class ApisextensionsvbetaApi(object):
    ...
    def list_namespaced_network_policy_6(self, **kwargs):
        """
        list or watch objects of kind NetworkPolicy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_namespaced_network_policy_6(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_namespaced_network_policy_6" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def list_namespaced_replica_set_7(self, **kwargs):
        """
        list or watch objects of kind ReplicaSet
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_namespaced_replica_set_7(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_namespaced_replica_set_7" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def patch_namespaced_scale_scale_9(self, body, namespace, name, **kwargs):
        """
        partially update scale of the specified Scale
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_namespaced_scale_scale_9(body, namespace, name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_namespaced_scale_scale_9" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_namespaced_scale_scale_9`")
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `patch_namespaced_scale_scale_9`")
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `patch_namespaced_scale_scale_9`")
    ...
    def read_namespaced_scale_scale_11(self, namespace, name, **kwargs):
        """
        read scale of the specified Scale
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.read_namespaced_scale_scale_11(namespace, name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_namespaced_scale_scale_11" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `read_namespaced_scale_scale_11`")
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `read_namespaced_scale_scale_11`")
    ...
    def replace_namespaced_scale_scale_13(self, body, namespace, name, **kwargs):
        """
        replace scale of the specified Scale
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.replace_namespaced_scale_scale_13(body, namespace, name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method replace_namespaced_scale_scale_13" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `replace_namespaced_scale_scale_13`")
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `replace_namespaced_scale_scale_13`")
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `replace_namespaced_scale_scale_13`")
    ...
    def watch_namespaced_daemon_set_list_14(self, namespace, **kwargs):
        """
        watch individual changes to a list of DaemonSet
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_daemon_set_list_14(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_daemon_set_list_14" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `watch_namespaced_daemon_set_list_14`")
    ...
    def watch_namespaced_deployment_list_15(self, namespace, **kwargs):
        """
        watch individual changes to a list of Deployment
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_deployment_list_15(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_deployment_list_15" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `watch_namespaced_deployment_list_15`")
    ...
    def watch_namespaced_horizontal_pod_autoscaler_list_16(self, namespace, **kwargs):
        """
        watch individual changes to a list of HorizontalPodAutoscaler
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_horizontal_pod_autoscaler_list_16(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_horizontal_pod_autoscaler_list_16" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `watch_namespaced_horizontal_pod_autoscaler_list_16`")
    ...
    def watch_namespaced_ingress_list_17(self, namespace, **kwargs):
        """
        watch individual changes to a list of Ingress
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_ingress_list_17(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_ingress_list_17" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `watch_namespaced_ingress_list_17`")
    ...
    def watch_namespaced_job_list_18(self, namespace, **kwargs):
        """
        watch individual changes to a list of Job
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_job_list_18(namespace, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_job_list_18" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params) or (params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `watch_namespaced_job_list_18`")
    ...
    def watch_namespaced_network_policy_list_19(self, **kwargs):
        """
        watch individual changes to a list of NetworkPolicy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_network_policy_list_19(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_network_policy_list_19" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def watch_namespaced_replica_set_list_20(self, **kwargs):
        """
        watch individual changes to a list of ReplicaSet
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.watch_namespaced_replica_set_list_20(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method watch_namespaced_replica_set_list_20" % key
                )
            params[key] = val
        del params['kwargs']
